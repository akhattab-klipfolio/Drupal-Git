(function ($) {
    Drupal.behaviors.FullPagePlugin = {
        attach: function() {
            $.fn.fullpage = function(options) {
            	$('body').addClass('FullPageLoaded');
        ...
        */      
        ...
        function scrollPage(element, callback, isMovementUp){
            ...
            // Show footer in the last section, and remove if scrolled up
            // if ( $('#FinalSection').hasClass('active') ) {
            //     $('#FinalSection #footer').addClass("move-up");
            //     $('#FinalSection #footer').addClass("easing");
            // }
            // else {
            //     $('#FinalSection #footer').removeClass("move-up");
            // }
        }
